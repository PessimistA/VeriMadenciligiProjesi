...
TARGET_PATH = '/content/Dental_Veri/YOLO/Dental_Veri_V3_Odakli'
...
print("1. AŞAMA: Veri Ön İşleme Başlıyor (CLAHE & Güvenli Şerit Kapatma)...")
...
print(f"Veri işleme tamam. {global_counter-1} kaliteli resim hazır, {atlanilan_resim_sayisi} ilgisiz resim elendi.")
...
yaml_save_path = f'{TARGET_PATH}/dental_data_v3.yaml'
with open(yaml_save_path, 'w') as f:
    yaml.dump(data_config, f, default_flow_style=False, sort_keys=False)

print("\n3. AŞAMA: YOLO11 Medium Eğitimi Başlıyor...")
...
results = model.train(
    ...
    workers=2,
    cache=True,
    project='/content/runs/detect/Dis_Projesi_V11',
    name='v11m_deneme1'
)
...
yedek_yolu = f'/content/drive/MyDrive/Veri_Madenciligi/YOLO/proje1_{zaman}'
os.makedirs(yedek_yolu, exist_ok=True)

kaynak_klasor = '/content/runs/detect/Dis_Projesi_V11/v11m_deneme1'
...
if os.path.exists(kaynak_klasor):
    ...
    print(f"❌ Hata: {kaynak_klasor} bulunamadı. Lütfen YOLO'nun kayıt yolunu kontrol et!")